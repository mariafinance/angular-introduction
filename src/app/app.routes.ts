...
import { HttpClientExamplComponent } from './components/http-client-exampl/http-client-exampl.component';
...
export const routes: Routes = [
    ...
    {path: 'http-client-example', component: HttpClientExamplComponent},
